...
counts_array_R0lowA<- incident_classifications(trim_combined_incident_R0lowA,trim_complete_R0lowA,R0lowA, prob_matrix_4)
counts_array_R0lowB<- incident_classifications(trim_combined_incident_R0lowB,trim_complete_R0lowB,R0lowB,prob_matrix_4)
counts_array_R0lowC<- incident_classifications(trim_combined_incident_R0lowC,trim_complete_R0lowC,R0lowC,prob_matrix_4)
counts_array_R0highA<- incident_classifications(trim_combined_incident_R0highA,trim_complete_R0highA,R0highA,prob_matrix_4)
counts_array_R0highB<- incident_classifications(trim_combined_incident_R0highB,trim_complete_R0highB,R0highB,prob_matrix_4)
counts_array_R0highC<- incident_classifications(trim_combined_incident_R0highC,trim_complete_R0highC,R0highC,prob_matrix_4)
