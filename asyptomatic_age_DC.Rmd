...
(6) `setup_sair_model_variableR0` `sair_step_variableR0`
...
sair_step_variableR0 <- function(stoch = F, R0vec, Ncomp, ICs, params, time, delta.t){
...
```{r initial_run variable R0}
  ...
  single.sim.varR0 <- sair_step_variableR0(stoch = TRUE, R0vec, Ncomp, ICs, params, time, delta.t)
