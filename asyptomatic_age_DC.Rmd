...
sair_step <- function(stoch = F, stoch.init = F, Ncomp, ICs, params, time, delta.t){
  C = params$C
  W = params$W
  beta0 = params$beta0
  beta1 = params$beta1
...
- `params`: a list of parameter values and objects, generated by the `setup_seir_model` model run for `R0vec[1]`. Code is provided below to generate a list from the output of `setup_seir_model`.
