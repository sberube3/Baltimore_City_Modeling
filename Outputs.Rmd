...
(1) We seed the epidemic with 8 asymptomatic cases and 2 symptomatic cases and assume homogeneous mixing within the population. 
(2) We assume the age structure of Baltimore City using data from the U.S. Census. 
...
(6) Of those that get put on a ventilator and of those that die, we apply a 11 day lag for the probability of death.
...
fig_nums(name = paste0("fig-one"), caption = paste("Plot of the median number of incident cases across simulations by day for each transmission scenario. These estimates are summed across all age groups."), display = "false")
```
...
fig_nums(name = paste0("fig-two"), caption = paste("Plot of the median number of incident hospitalizations across simulations by day for each transmission scenario. These estimates are summed across all age groups."), display = "false")
```
...
fig_nums(name = paste0("fig-three"), caption = paste("Plot of the median number of deaths across simulations by day for each transmission scenario. These estimates are summed across all age groups."), display = "false")
```
...
fig_nums(name = paste0("fig-four"), caption = paste("A. Plot of daily hospitalizations for each transmission scenario across all age categories. B. Plot of daily ICU admissions for each transmission scenario across all age categories. C. Plot of number of daily ventilators needed for each transmission scenario across all age categories."), display = "false")
