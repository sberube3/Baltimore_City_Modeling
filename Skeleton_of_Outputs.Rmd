...
wide_incident_cases<- as.data.frame(cbind(rep(1:length(incident_cases_R017_100)),
                      incident_cases_R017_100,incident_cases_R017_75,
                      incident_cases_R017_50,incident_cases_R021_100,incident_cases_R021_75,
                      incident_cases_R021_50,incident_cases_R025_100,
                      incident_cases_R025_75,incident_cases_R025_50))


colnames(wide_incident_cases)<- c("Day","R_0=1.7,100","R_0=1.7,75","R_0=1.7,50","R_0=2.1,100",
                                  "R_0=2.1,75","R_0=2.1,50","R_0=2.5,100","R_0=2.5,75",
                                  "R_0=2.5,50")
long_incident_cases<- gather(wide_incident_cases,scenario, incident_cases,
                             "R_0=1.7,100":"R_0=2.5,50", factor_key=TRUE)


plt_incident_cases<- ggplot(long_incident_cases)+ 
...
```{r, message=FALSE, warning=FALSE, echo=TRUE}
incident_hosp_R017_100<- apply(counts_array_median_R017_100[,,2],1,sum)
incident_hosp_R017_75<- apply(counts_array_median_R017_75[,,2],1,sum)
incident_hosp_R017_50<- apply(counts_array_median_R017_50[,,2],1,sum)
incident_hosp_R021_100<- apply(counts_array_median_R021_100[,,2],1,sum)
incident_hosp_R021_75<- apply(counts_array_median_R021_75[,,2],1,sum)
incident_hosp_R021_50<- apply(counts_array_median_R021_50[,,2],1,sum)
incident_hosp_R025_100<- apply(counts_array_median_R025_100[,,2],1,sum)
incident_hosp_R025_75<- apply(counts_array_median_R025_75[,,2],1,sum)
incident_hosp_R025_50<- apply(counts_array_median_R025_50[,,2],1,sum)


wide_hosp_cases<- as.data.frame(cbind(rep(1:length(incident_hosp_R017_100)),
                      incident_hosp_R017_100,incident_hosp_R017_75,
                      incident_hosp_R017_50,incident_hosp_R021_100,incident_hosp_R021_75,
                      incident_hosp_R021_50,incident_hosp_R025_100,
                      incident_hosp_R025_75,incident_hosp_R025_50))


colnames(wide_hosp_cases)<- c("Day","R_0=1.7,100","R_0=1.7,75","R_0=1.7,50","R_0=2.1,100",
                                  "R_0=2.1,75","R_0=2.1,50","R_0=2.5,100","R_0=2.5,75",
                                  "R_0=2.5,50")
long_hosp_cases<- gather(wide_hosp_cases,scenario, incident_cases,
                             "R_0=1.7,100":"R_0=2.5,50", factor_key=TRUE)


plt_hosp_cases<- ggplot(long_hosp_cases)+ 
  geom_line(aes(y= incident_cases, x=Day,color=scenario))+
  labs(title="Median Incident Hospitalizations Per Day",
       y="Median Number of Incident Hospitalizations")
...
incident_death_R017_100<- apply(counts_array_median_R017_100[,,5],1,sum)
incident_death_R017_75<- apply(counts_array_median_R017_75[,,5],1,sum)
incident_death_R017_50<- apply(counts_array_median_R017_50[,,5],1,sum)
incident_death_R021_100<- apply(counts_array_median_R021_100[,,5],1,sum)
incident_death_R021_75<- apply(counts_array_median_R021_75[,,5],1,sum)
incident_death_R021_50<- apply(counts_array_median_R021_50[,,5],1,sum)
incident_death_R025_100<- apply(counts_array_median_R025_100[,,5],1,sum)
incident_death_R025_75<- apply(counts_array_median_R025_75[,,5],1,sum)
incident_death_R025_50<- apply(counts_array_median_R025_50[,,5],1,sum)


wide_death_cases<- as.data.frame(cbind(rep(1:length(incident_death_R017_100)),
                      incident_death_R017_100,incident_death_R017_75,
                      incident_death_R017_50,incident_death_R021_100,incident_death_R021_75,
                      incident_death_R021_50,incident_death_R025_100,
                      incident_death_R025_75,incident_death_R025_50))


colnames(wide_death_cases)<- c("Day","R_0=1.7,100","R_0=1.7,75","R_0=1.7,50","R_0=2.1,100",
                                  "R_0=2.1,75","R_0=2.1,50","R_0=2.5,100","R_0=2.5,75",
                                  "R_0=2.5,50")
long_death_cases<- gather(wide_death_cases,scenario, incident_cases,
                             "R_0=1.7,100":"R_0=2.5,50", factor_key=TRUE)


plt_death_cases<- ggplot(long_death_cases)+ 
  geom_line(aes(y= incident_cases, x=Day,color=scenario))+
