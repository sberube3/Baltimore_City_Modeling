...
#no so its 8 days from icu to death and 4.5 days from vent to death which are the only two ways you can die according to our model and its reflected with a lag in probability multiplication.
#11 days is hospital to discharge and vent to discharge.
...
counts_array_R017<- incident_classifications(trimcombined_incident_R017,complete_R017,R017)
